...
public final class StdOut {
    /**
     * force Unicode UTF-8
     * encoding; otherwise it's system dependent.
     */
    private static final String CHARSET_NAME = "UTF-8";
    /**
     * assume language = English.
     * country = US for consistency with StdIn.
     */
   ...
   /**
     ...
     * @deprecated Calling close() 
     * permanently disables standard output;
     * subsequent calls to StdOut.println()
     * or System.out.println()
     * will no longer produce output on
     * standard output.
     */
    @Deprecated
   ...
   /**
     * Terminates the current line by
     * printing the line-separator string.
     */
   ...
   /**
     * Prints an object to this output
     * stream and then terminates the line.
     *
   ...
   /**
     * Prints a boolean to standard output
   ...
   /**
     * Prints a character to standard
     * output and then terminates the line.
     *
   ...
   /**
     * Prints a long to standard output and
   ...
   /**
     * Prints a short integer to standard
     * output and then terminates the line.
     *
   ...
   /**
     * Prints a byte to standard output and
     * then terminates the line.
     * <p>
   ...
   /**
     * Prints a long integer to standard
     * output and flushes standard output.
     * 
   ...
   /**
     * Prints a formatted string to standard
     * output, using the specified format
     * string and arguments, and then flushes
     * standard output.
     *
     *
     * @param format the <a href = "http://
     * docs.oracle.com/javase/7/docs/api/java/
     * util/Formatter.html#syntax">format string</a>
   ...
   /**
     * Prints a formatted string to standard
     * output, using the locale and
     * the specified format string and arguments;
     * then flushes standard output.
     *
     * @param locale the locale
     * @param format the <a href = "http://docs.
     * oracle.com/javase/7/docs/api/java/util/Formatter
